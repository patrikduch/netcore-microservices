...
/**
 * @class Entry page component for root customers route of the administration.
 */
class CustomerAdminPage extends React.Component<IProps, IState> {
    ...
    render() {
        ...
        return (
            <div>
                <Helmet>
                    <meta data-react-helmet="true" name="title" content="E-commerce template | Customer's management "/>
                    <meta property="og:title" content="E-commerce template" />
                    <title>E-commerce template | Customer's management</title>
                </Helmet>

                <div className='container mt-4 page-container'>
                    <PageTitle>Customer's management</PageTitle>
                </div>
            </div>
        );
    }
