 ...
 */
class DashAdminPage extends React.Component<IProps, IState> {
    ...
    render() {
        ...
        return (
            <div>
                <Helmet>
                    <meta data-react-helmet="true" name="title" content="E-commerce template | Dashboard "/>
                    <meta property="og:title" content="E-commerce template" />
                    <title>E-commerce template | Dashboard</title>
                </Helmet>
