...
namespace Product.Persistence.Migrations
{
    ...
    [Migration("20221216230003_ProductDataSeed")]
            ...
            modelBuilder.Entity("Product.Domain.Entities.CategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c47f5493-b9a7-4eb5-812c-74bf453bdce9"),
                        ...
                        new
                        {
                            Id = new Guid("58ce0303-7e7a-42d9-af9f-4d7d18aa5991"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Movies",
                            Url = "movies"
                        },
                        new
                        {
                            Id = new Guid("6bf62e98-a1b4-4e18-9263-8a50e1b20a4a"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Video Games",
                            Url = "video-games"
                        });
            ...
            modelBuilder.Entity("Product.Domain.Entities.ProductEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1ec293b1-7f87-4c52-a5af-24c1d0a0ac9f"),
                            CategoryId = new Guid("a5fc30db-2d2e-44fb-b2e1-ab18ad43c691"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("0b5be7ec-8c0c-47b0-9849-dca1797070e7"),
                            CategoryId = new Guid("a5fc30db-2d2e-44fb-b2e1-ab18ad43c691"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("7bda4e1f-56e6-4826-b847-e3e830cddc26"),
                            CategoryId = new Guid("a5fc30db-2d2e-44fb-b2e1-ab18ad43c691"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("ec0fe11b-568e-466f-bcda-85c6c320d0ba"),
                            CategoryId = new Guid("52ca3d2e-1cd8-4247-bf8e-5ac8267d2de5"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("6a91e50b-15ba-4c8f-84ec-8c93d93cb880"),
                            CategoryId = new Guid("52ca3d2e-1cd8-4247-bf8e-5ac8267d2de5"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("353dae23-5058-4cd7-bcf4-b13a132951ca"),
                            CategoryId = new Guid("52ca3d2e-1cd8-4247-bf8e-5ac8267d2de5"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("d02eb2b2-5808-43ed-9562-93d874c8ca17"),
                            CategoryId = new Guid("430c6139-b227-449e-9936-d6e398eebeab"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("9d93185c-050b-4d0a-b7b5-c3f99c369e30"),
                            CategoryId = new Guid("430c6139-b227-449e-9936-d6e398eebeab"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("c719e527-ca69-44ff-94fd-560b27db9965"),
                            CategoryId = new Guid("430c6139-b227-449e-9936-d6e398eebeab"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("5a80271e-8537-4764-9347-a45a18a252d0"),
                            CategoryId = new Guid("430c6139-b227-449e-9936-d6e398eebeab"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("8a8cac17-da91-45f5-a4b3-b18572567eba"),
                            CategoryId = new Guid("430c6139-b227-449e-9936-d6e398eebeab"),
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
