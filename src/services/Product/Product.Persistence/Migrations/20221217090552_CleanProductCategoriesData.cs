...
{
    public partial class CleanProductCategoriesData : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("58ce0303-7e7a-42d9-af9f-4d7d18aa5991"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "Movies", "movies" },
                    { new Guid("6bf62e98-a1b4-4e18-9263-8a50e1b20a4a"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "Video Games", "video-games" },
                    { new Guid("c47f5493-b9a7-4eb5-812c-74bf453bdce9"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "Books", "books" }
                });
